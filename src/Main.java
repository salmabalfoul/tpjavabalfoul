...
import lsttpjava.Controllers.DepartementsController;
import lsttpjava.Models.Enseignant;
import lsttpjava.Services.DB;

import static lsttpjava.Services.EtudiantServices.DB;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        enseignant.setNom("hajar");
        enseignant.setPrenom("mari");
        enseignant.setEmail("jarrmaro@gmail.com");
        enseignant.setGrade("prof");
        enseignant.setId(Services.DB.getEnsId());
        services.DB.enseignants.add(enseignant);
        showPrincipalMenu();
    }
};
